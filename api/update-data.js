...
const PROJECTS = {
    ...
    withoutToken: [
        ...
        // { name: 'Variational', llamaSlug: 'variational', logo: 'https://icons.llamao.fi/icons/protocols/variational?w=48&h=48', customApi: 'variational', url: 'https://www.variational.io/', pointsSeasonStart: '2025-12-17', pointsMax: 9000000, pointsMaxInfo: 'Source : Données dispo dans la doc du projet', airdropPct: 25, comment: 'Relativement early. À utiliser pour la majorité de tes DN, récompense énormément les positions longues sur les paires avec peu d\'OI.' }, // Désactivé en attente DeFiLlama
